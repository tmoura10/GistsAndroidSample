...
class GetGistsInteractorImplTest {

    private lateinit var gistRepository: GistRepository
    private lateinit var schedulersProvider: SchedulersProvider
    private lateinit var getGistsInteractor: GetGistsInteractorImpl
    ...
    fun `run before each test`() {
        ...
        transformer = mock()
        getGistsInteractor = GetGistsInteractorImpl(gistRepository = gistRepository,
